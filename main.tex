...
\begin{align*}
    t_{2006} = \frac{\$7,414}{\$17,910} &= 38.58\% \\
\end{align*}
...
\color{orange}
This makes sense because we assume a constant cost of debt $r_D$, which means that as the debt fraction goes up there's a lesser proportion of equity, so it's a decreasing linear relationship.
\color{black}
